...
from yarll.common.tile_images import tile_images
...
class VecEnv(ABC):
    ...
    def get_attr(self, attr_name, indices=None):
        ...
        :param indices: (list,int) Indices of vec_env to get attribute from
    ...
    def set_attr(self, attr_name, value, indices=None):
        ...
        :param indices: (list,int) Indices of vec_env to assign value
        :return: (NoneType)
        """
        pass
    ...
    def env_method(self, method_name, *method_args, indices=None, **method_kwargs):
        ...
        :param indices: (list,int) Indices of vec_env whose method to call
    ...
    def _get_indices(self, indices):
        ...
        :param indices: (None,int,Iterable) refers to indices of vec_env.
