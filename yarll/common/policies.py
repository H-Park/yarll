...
def create_policy(flat_observations, net_arch, act_fun):
    """
...
class FeedForwardPolicy(ActorCriticPolicy):
    ...
    :param ac_spaces: [(Gym Space)] The action space of the environment
    :param n_env: (int) The number of environments to run
    :param n_steps: (int) The number of steps to run for each environment
    :param n_batch: (int) The number of batch to run (n_envs * n_steps)
    :param reuse: (bool) If the policy is reusable or not
    ...
    def __init__(self, ob_spaces, ac_spaces, n_env, n_steps, n_batch, reuse=False, layers=None, net_arch=None,
                 act_fun=tf.tanh, cnn_extractor=nature_cnn, feature_extraction="cnn", **kwargs):
        super(FeedForwardPolicy, self).__init__(ob_spaces, ac_spaces, n_env, n_steps, n_batch, reuse=reuse,
        ...
        if net_arch is None:
            ...
            pi_latent, vf_latent = create_policy(tf.layers.flatten(self.processed_obs), net_arch, act_fun)

            # TODO: Make one last layer for vf_latent -> 1
            #
...
class MlpPolicy(FeedForwardPolicy):
    ...
    def __init__(self, ob_spaces, ac_spaces, n_env, n_steps, n_batch, reuse=False, **_kwargs):
        super(MlpPolicy, self).__init__(ob_spaces, ac_spaces, n_env, n_steps, n_batch, reuse,
